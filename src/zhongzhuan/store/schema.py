...
SQLITE_MIGRATIONS = [
    ...
    "ALTER TABLE models ADD COLUMN upstream_path_prefix TEXT NOT NULL DEFAULT ''",
...
MYSQL_MIGRATIONS = [
    ...
    "ALTER TABLE models ADD COLUMN IF NOT EXISTS upstream_path_prefix VARCHAR(256) NOT NULL DEFAULT ''",
...
CREATE TABLE IF NOT EXISTS models (
    ...
    upstream_path_prefix VARCHAR(256) NOT NULL DEFAULT '',
